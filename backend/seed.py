    ...
    try:
        ...
        report = Report(
            ...
            case_summary_json={
                ...
                "service_activity": "The SOC handled 4 security cases for Apex Energy during this period.",
            },
            sla_summary_json={"compliance_percentage": 92.5, "summary": "SLA performance remained strong."},
            notable_incidents_json={
                "items": [{"title": "Privileged account login outside hours", "severity": "High"}],
                "notable_cases": [{"title": "Privileged account login outside hours", "severity": "High"}],
            },
            ...
            recommendations_json={
                ...
                "recommended_actions": ["Enable MFA for privileged accounts", "Review OAuth app permissions"],
                "next_month_focus": ["OAuth app permission review", "Privileged access monitoring"],
                "human_ai_triage_summary": "AI-assisted triage supported analyst decisions with 75% acceptance rate.",
                "ai_triage_oversight": "AI-assisted triage supported analyst decisions with 75% acceptance rate. All dispositions were analyst-approved.",
                "trust_metrics_summary": {
                    "trust_calibration_score": 78,
                    "human_ai_agreement_rate": 75,
                    "ai_acceptance_rate": 75,
                    "override_count": 2,
                },
                "soc_value_narrative": "TrustOps enabled consistent case management and measurable SLA governance.",
                "value_delivered": "TrustOps enabled consistent case management and measurable SLA governance.",
            },
            status="Published",
